...
public class Juego {
	...
	private int cantidadRondas;
			...
			public void determinarGanador(String atributo) {
				...
				distribuirCartaGanada(cartaJugador1,cartaJugador2, valorComparacion);
			...
			private void distribuirCartaGanada(Carta cartaJugador1, Carta cartaJugador2, double valorComparacion) {
				if(valorComparacion>0) {
					ganador=j1;
			...
			private String MensajePocima(Carta carta, String atributo) {
				if(carta.getPocima()!=null) {
					return ", se aplicó pócima "+carta.getPocima().getNombre()+" valor resultante "+
							(int)carta.getPocima().modificarAtributo(carta.getAtributoCarta(atributo));
				}
				else return "";
			}
