...
public class Voluntario extends ElementZona{
	...
	private ArrayList<String>enfermedadesPre;
	...
	public boolean equals(Object o) {
		try {
			...
			//para mayor precicion se deberia tener un dni de cada voluntario
		}catch(Exception exc) {
			return false;
		}
	}
	...
	public String toString() {
		return "Voluntario [nombre: "+ this.getNombre()+" nacionalidad=" + nacionalidad + ", edad=" + edad + ", genero=" + genero
				+ ", enfermedadesPre=" + enfermedadesPre + ", recibioPlacebo=" + recibioPlacebo
				+ ", contrajoEnfermedad=" + contrajoEnfermedad + "]";
	}
