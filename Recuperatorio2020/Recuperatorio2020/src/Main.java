...
public class Main {
	...
	Criterio criterioEnfermedad2= new CriterioContieneEnfermedadPreexistente("gripe");
	...
	System.out.println("la cantidad de voluntarios por Criterio son: "+grupoTandil.cantidadVoluntariosCriterio(criterioPlacebo));
	System.out.println("porcentaje de voluntarios por tal criterio: "+ grupoTandil.porcentajeVoluntariosCriterio(criterioEnfermedad2));
	System.out.println(grupoTandil.ListaVoluntariosVacuna(criterioEnfermedad));
