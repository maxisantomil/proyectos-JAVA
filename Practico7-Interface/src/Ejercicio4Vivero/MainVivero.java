...
public class MainVivero {
	...
	Fichaplanta planta3= new Fichaplanta("Petritiuf Delem","crassulas" , "acacias", "b", 3, 6);
	planta3.agregarnombreVulgar("la llorona");
	planta3.agregarnombreVulgar("malefica");
	Fichaplanta planta4= new Fichaplanta("Petritiuf tifum","crassulas" , "ggrrggr", "a", 50, 8);
	...
	Comparator<Fichaplanta> comparatorSol= new ComparatornivelSol();
	Comparator<Fichaplanta> comparatorRiego= new ComparatorRiego();
	Comparator<Fichaplanta> comparatorNVulgar= new ComparatorNombreVulgar();
	
	//System.out.println(vivero.toString());
	
	//System.out.println(vivero.listaxCriterio(filtroClasificacion));
	System.out.println(vivero.listaordenadaxComparador(filtroClasificacion, comparatorNVulgar));
